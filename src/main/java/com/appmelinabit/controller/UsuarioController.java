...
public class UsuarioController {
    ...
    public ResponseEntity<?> criarUsuario(@RequestBody Usuario usuario) {
        ...
        // CORREÇÃO AQUI: MUDAR isLgpdAceito() PARA getLgpdAceito()
    ...
    @PreAuthorize("hasRole('ADMIN')")
    // Note: Mantenha 'UsuarioStatusUpdateRequest' aqui se não a moveu, mas é recomendável o import.
...
// RECOMENDAÇÃO: MOVER ESTA CLASSE PARA UM ARQUIVO SEPARADO DENTRO DE UM PACOTE DTO/REQUEST
